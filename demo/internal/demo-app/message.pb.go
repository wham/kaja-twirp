...
var file_proto_lib_message_proto_rawDesc = []byte{
...
var (
	...
	file_proto_lib_message_proto_rawDescData = file_proto_lib_message_proto_rawDesc
)

func file_proto_lib_message_proto_rawDescGZIP() []byte {
	file_proto_lib_message_proto_rawDescOnce.Do(func() {
		file_proto_lib_message_proto_rawDescData = protoimpl.X.CompressGZIP(file_proto_lib_message_proto_rawDescData)
	})
...
func file_proto_lib_message_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_lib_message_proto_msgTypes[0].Exporter = func(v any, i int) any {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_proto_lib_message_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_proto_lib_message_proto_rawDesc = nil
