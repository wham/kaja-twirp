...
var file_xxl_methods_proto_goTypes = []interface{}{
...
func file_xxl_methods_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_xxl_methods_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_xxl_methods_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
